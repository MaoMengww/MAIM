...
CREATE TABLE IF NOT EXISTS bot.bot_memories (
    ...
    predicate        VARCHAR(128) DEFAULT '' NOT NULL,
...
DO $$ BEGIN
    ALTER TABLE bot.bot_memories ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME bot.bot_memories_id_seq
...
CREATE INDEX IF NOT EXISTS idx_bot_memories_scope_importance ON bot.bot_memories(bot_id, user_id, importance DESC);
