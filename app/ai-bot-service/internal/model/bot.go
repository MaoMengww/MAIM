...
type Bot struct {
	...
	MaxContextTokens         int            `gorm:"column:max_context_tokens" json:"max_context_tokens"`
	...
	MemoryEmbeddingModelName string         `gorm:"column:memory_embedding_model_name" json:"memory_embedding_model_name"`
	MemoryEmbeddingModelID   int64          `gorm:"column:memory_embedding_model_id" json:"memory_embedding_model_id"`
